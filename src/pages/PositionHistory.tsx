...
const PositionHistory: React.FC = () => {
    ...
    return (
        <div className="p-4 md:p-8 max-w-4xl mx-auto">
            ...
            {/* Data container — con 'relative', 'min-h-[260px]' y 'pb-4' para mantener la tarjeta amplia al abrir el menú desplegable */}
            {!isLoading && positions.length > 0 && (
                <div className="bg-white rounded-2xl shadow-sm min-h-[260px] relative pb-4">
