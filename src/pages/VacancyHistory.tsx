                                    ...
                                    <tr key={vac.id} className="hover:bg-gray-50 transition-colors relative">
                                        ...
                                        <td className="px-4 py-3.5 text-center">
                                            <button
                                                ...
                                                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-white transition-colors"
                                                style={{ backgroundColor: '#447ECA' }}
                                                onMouseOver={e => (e.currentTarget.style.backgroundColor = '#3a6bb8')}
                                                onMouseOut={e => (e.currentTarget.style.backgroundColor = '#447ECA')}
                                                title="Ver Resultados IA"
                                            >
                                                <Eye size={12} /> Resultados
                                            </button>
                                        </td>
                                        ...
                                        <td className="px-4 py-3.5 text-right relative">
                                            ...
                                            {openMenuId === vac.id && (
                                                <div
                                                    className="absolute right-4 top-12 w-52 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50 text-left"
